        ...
        <div className="bg-white text-black p-12 md:p-16 rounded-sm shadow-2xl relative overflow-hidden print:shadow-none print:p-0">
          ...
          <div className="flex justify-between items-start mb-16">
            ...
            <div className="text-right">
              <h2 className="text-4xl font-light text-black/20 uppercase tracking-widest mb-4">
                Invoice
              </h2>
          ...
          <div className="mb-12">
            ...
            {invoice.items.map((item, idx) => (
              <div
                key={idx}
                className="grid grid-cols-12 gap-4 py-4 border-b border-black/5 items-center"
              >
                <div className="col-span-6 font-medium">{item.name}</div>
                <div className="col-span-2 text-center text-black/60">
                  {item.qty}
                </div>
                <div className="col-span-2 text-right text-black/60">
          ...
          <div className="border-t border-black/10 pt-8 text-center text-sm text-black/40">
            ...
            <p>
              Authorization Code: #VB-AUTH-8821 • payment verified via Credit
              Card
            </p>
          </div>
